...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    if (!empty($message)) {
        ...
        if (mysqli_query($conn, $sql)) {
            echo '<script>alert("Lời nhắn đã được gửi lại thành công.")</script>';
        ...
        echo '<script>alert("Vui lòng nhập nội dung lời nhắn.")</script>';
    }
}
...
<html>
<head>
<title>TRẢ LỜI YÊU CẦU CỦA THÍ SINH - Chương trình quản lý tuyển sinh</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="nhanlaichosinhvien.php" class="nav-item nav-link active">MESSAGE</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">TRẢ LỜI YÊU CẦU CỦA THÍ SINH</h1>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" class="login-form">
                        <div class="sign-in-htm"> 
                            ...
                            <div class="group">
                                <label for="feedback_id" class="label">Mã yêu cầu</label>
                                <input type="text" class="input2" name="feedback_id" required><br>
                            </div>

                            <div class="group">
                                <label for="message" class="label">Nội dung lời nhắn</label><br>
                                <textarea name="message" rows="5" cols="40" class="input2"></textarea><br>
                            </div>

                            <div class="group">                            
                                <input type="submit" class="button" name="submit" value="GỬI LỜI NHẮN CHO THÍ SINH">
                            </div>
                        </div>
    </form>
                </div>
