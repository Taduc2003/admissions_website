...
<head>
    <meta charset="UTF-8">
    <title>XEM ĐIỂM - Chương trình quản lý tuyển sinh</title>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="xemdiem.php" class="dropdown-item active">View Student's Scores</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">XEM ĐIỂM</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">VIEW</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">View Student's Scores</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<thead>";
    echo "<tr>";
    echo "<th scope='col'>Mã thí sinh</th>";
    echo "<th scope='col'>Họ và tên</th>";
    echo "<th scope='col'>Toán</th>";
    echo "<th scope='col'>Vật lý</th>";
    echo "<th scope='col'>Hóa học</th>";
    echo "<th scope='col'>Tiếng Anh</th>";
    echo "<th scope='col'>Ngữ văn</th>";
    echo "</tr>";
    echo "</thead>";
    echo "<tbody>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "</td>";
        $scores[$row['exam_name']] = $row['result_score'];
    }
    echo "</tr>";
    echo "</tbody>";
    echo "</table>";
    $diem_theo_khoi = array(
        'A00' => array('Math', 'Physics', 'Chemistry'),
        'A01' => array('Math', 'Physics', 'English'),
        'D01' => array('Literature', 'Math', 'English'),
        'D07' => array('Math', 'Chemistry', 'English')
    );
    foreach ($diem_theo_khoi as $khoi => $subjects) {
        $total_score = 0;
        ...
        $block_score = number_format($total_score, 1);
        echo "<p style='text-align:center'>Điểm khối $khoi của bạn là: $block_score</p>";
    }
} else {
    echo '<script>alert("Không tìm thấy thông tin điểm.")</script>';
}
mysqli_close($conn);
?>
